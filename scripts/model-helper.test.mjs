...
test('catalog model ID and context produce client config without hardcoded model aliases',()=>{
 ...
 assert.deepEqual(config.language_models.openai_compatible['kilo-local'].available_models,[{name:m.id,display_name:m.id,max_tokens:128000,max_output_tokens:8192}]);
